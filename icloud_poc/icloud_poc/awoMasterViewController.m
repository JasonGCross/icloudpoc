...
#import "awoDetailViewController.h"
#import "Photo.h"



@interface awoMasterViewController ()
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath;
@end

@implementation awoMasterViewController
...
- (void)viewDidLoad
{
    ...
    self.detailViewController = (awoDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    label.text = [[photoObject valueForKey:@"dateAdded"] description];
    
    UIImageView * imageView = (UIImageView *)[cell viewWithTag:101];
    NSData * thumbnailData = [photoObject thumbnailImageData];
    if (nil != thumbnailData) {
        UIImage * thumb = [UIImage imageWithData:thumbnailData];
...
{
    if (nil == __managedObjectContext) {
        __managedObjectContext = [[self fetchedResultsController] managedObjectContext];
    }
